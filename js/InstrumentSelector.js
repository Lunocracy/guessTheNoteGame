...
class InstrumentSelector {
  constructor(gameInstance) {
      ...
      this.spriteSize = 300;
      this.spriteUrl = 'resources/instruments.png'; // Root-relative path
    }
  ...
  start() {
      this.currentDisplay = makeElement('div', {
        ...
        style: {
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center', boxSizing: 'border-box', transition: 'transform 0.2s, opacity 0.2s ease',
        },
      });
