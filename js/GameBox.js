class GameBox {
  ...
  start(rootElement) {
      ...
      this.noteDisplay = makeElement('div', {
        ...
        style: { visibility: 'hidden', margin: '0', boxSizing: 'border-box', display: 'flex', justifyContent: 'center', gap: '20px', alignItems: 'center', width: '100%', flexGrow: '1' },
      });
      this.div.appendChild(this.noteDisplay);

      this.buttonSlot = makeElement('div', {
        id: 'button-slot',
        style: { boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', flexShrink: '0', gap: '10px' },
      });
      this.div.appendChild(this.buttonSlot);

      this.startButton = makeElement('button', {
        id: 'startButton', textContent: 'Single Player',
      ...
      this.startTwoPlayerButton = makeElement('button', {
        id: 'startTwoPlayerButton', textContent: '2-Player Game',
        style: { visibility: 'visible', fontFamily: 'inherit', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' },
      });
  ...
  updateUI(state) {
      ...
      if (this.startTwoPlayerButton) {
        this.startTwoPlayerButton.style.visibility = isIdle ? 'visible' : 'hidden';
      }
  ...
  getStartTwoPlayerButton() {
      return this.startTwoPlayerButton;
    }
}
